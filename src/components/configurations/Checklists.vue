...
<script>
    ...
    import checklistsService from '@/services/checklists/checklist.service'
        ...
        methods: {
            ...
            saveItem (item) {
                ...
                if (item.id) { // Edit
                    ...
                    request = checklistsService.items.update(parameters)
                } else { // New
                    parameters = {
                        data: {
                    ...
                    request = checklistsService.items.create(parameters)
                };
            ...
            fetchChecklists () {
                ...
                return checklistsService.retrieve(parameters).then(response => {
                    if (response.data.status === 'success') {
            ...
            save () {
                ...
                if (self.editingChecklists.id) { // Edit
                    ...
                    request = checklistsService.update(parameters)
                } else { // New
                    parameters = {
                        data: {
                            description: self.editingChecklists.description,
                    ...
                    request = checklistsService.create(parameters)
                };
            ...
            fetchChecklistItems (checklistId) {
                ...
                return checklistsService.items.retrieve(parameters).then(response => {
                    if (response.data.status === 'success') {
